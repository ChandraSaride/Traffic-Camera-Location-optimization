...
set output 'graph_time_ex.png'

# Set titles of the graph and axis
set style data lines
#set title "Running times for VC-1,VC-2 approximations"
set xlabel "Vertices"
...
plot  [0:50] "vc1_time_file.dat" using 1:2:3 title "VC-1 Run" with lines,\
 "vc1_time_file.dat" using 1:2:3 notitle with yerr,\
 "vc2_time_file.dat" using 1:2:3 title "VC-2 Run" with lines,\
 "vc2_time_file.dat" using 1:2:3 notitle with yerr
