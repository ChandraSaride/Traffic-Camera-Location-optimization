...
def vertex_gen(street_data):
    ...
    all_checked_finallist=[]
    for a,b in edges_list:
        if(a!=b):
            all_checked_finallist.append((a,b))

    return vertex_data,list(set(all_checked_finallist))
    ...
    while True:
        try:
            ...
            if cmd =='a':
                ...
                print(('V ')+str(len(vertex_data)),file=sys.stdout)
                ...
                for i in elist:
                    ...
                    if not(tmp_cnt==chk_cnt):
                        print("<"+str(i[0])+","+str(i[1])+">,",end="", file=sys.stdout)
                    else:
                        print("<" + str(i[0]) + "," + str(i[1]) + ">",end="", file=sys.stdout)
